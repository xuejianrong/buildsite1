...
<div class="container-fluid">
	...
	<div class="row"><div class="col-lg-12"><button type="button" class="btn btn-primary" onclick="editManagerGroup(this, 0);">+ 新建</button></div></div>
	<br />
	<div class="row">
					...
					'aColumns' => [
						...
						'operate' =>	[
							...
							'content' => function($aData){
								return '<a href="javascript:;" onclick="editManagerGroup(this, ' . $aData['id'] . ');">编辑</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="javascript:;" onclick="deleteManagerGroup(this, ' . $aData['id'] . ');">删除</a>';
							}
						],
					],
					'aDataList'	=>	$aList,
...
<script type="text/javascript">
	...
	function buildManagerGroupBoxHtml(aData){
		var html = '';
		html += '<div class="form-group">';
			html += '<label>角色名称</label>';
	...
	function editManagerGroup(o, id){
		id = parseInt(id);
		var aData = {};
		...
		$.teninedialog({
			...
			content : buildManagerGroupBoxHtml(aData),
			url : '',
			...
			clickButton : function(sender, modal, index){
				if(index == 0){
					...
					ajax({
						url : Tools.url('manage', 'manager-group/save'),
						data : {
							id : id,
							name : $('.J-cp-name').val()
						},
	...
	function deleteManagerGroup(o, id){
		UBox.confirm('确定删除？', function(){
			if($(o).attr('disabled')){
				return;
			}
			ajax({
				url : Tools.url('manage', 'manager-group/delete'),
				data : {
					id : id
				},
				beforeSend : function(){
