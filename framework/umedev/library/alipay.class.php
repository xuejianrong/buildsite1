<?php
define('ALIPAY_PARTNER_ID', '2088011637034689');
define('ALIPAY_KEY_ID', 'bqfbtcqmayoy8iybg7t2864qqrn2ygbv');
define('CACERT_PEM', SYSTEM_BASE_PATH . 'library/support/cacert.pem');
