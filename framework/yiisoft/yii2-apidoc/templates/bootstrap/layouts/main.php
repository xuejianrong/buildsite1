...
<head>
	...
	<meta http-equiv="Last-Modified" content="Mon, 26 Jul 1970 05:00:00 GMT">
    <?= Html::csrfMetaTags() ?>
    <?php $this->head() ?>
...
<div class="wrap">
    ...
    if ($this->context->apiUrl !== null) {
        $nav[] = ['label' => '类参考文档', 'url' => rtrim($this->context->apiUrl, '/') . '/index.html'];
...
<footer class="footer">
	<p class="pull-left">&copy; UmFun <?= date('Y') ?></p>
    <p class="pull-right"><small>文档生成时间: <?= date('r') ?></small></p>
    <?= Yii::powered() ?>
</footer>
